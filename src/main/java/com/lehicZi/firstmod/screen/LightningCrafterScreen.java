...
public class LightningCrafterScreen extends ContainerScreen<LightningCrafterContainer> {

    private final ResourceLocation GUI = new ResourceLocation(FirstMod.MOD_ID,
            "textures/gui/lightning_crafter_gui.png");

    public LightningCrafterScreen(LightningCrafterContainer lightningCrafterContainer, PlayerInventory p_i51105_2_, ITextComponent p_i51105_3_) {
        super(lightningCrafterContainer, p_i51105_2_, p_i51105_3_);
    }
