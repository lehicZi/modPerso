...
public class LightningCrafterContainer extends Container {
    ...
    public LightningCrafterContainer(int windowId, World world, BlockPos blockPos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.LIGHTNING_CRAFTER_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerIn, ModBlocks.LIGHTNING_CRAFTER.get());
    }
