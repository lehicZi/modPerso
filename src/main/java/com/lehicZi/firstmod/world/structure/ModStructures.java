package com.lehicZi.firstmod.world.structure;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import com.lehicZi.firstmod.FirstMod;
import com.lehicZi.firstmod.world.structure.structures.Dj1Structure;
...
public class ModStructures {
    ...
    public static DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, FirstMod.MOD_ID);


    public static final RegistryObject<Structure<NoFeatureConfig>> DJ1 =
            STRUCTURES.register("dj1", Dj1Structure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(DJ1.get(),
