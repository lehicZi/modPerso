...
import com.lehicZi.firstmod.world.gen.ModStructureGeneration;
...
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if (event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(ModStructures.DJ1.get(),
                    DimensionStructuresSettings.field_236191_b_.get(ModStructures.DJ1.get()));
