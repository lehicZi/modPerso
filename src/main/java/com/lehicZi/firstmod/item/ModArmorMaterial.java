...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    RUBY("ruby", 35, new int[]{4, 7, 9, 4}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND
            , 3.0F, 0.2F, () -> Ingredient.fromItems(ModItems.RUBY.get())),

    EMERALD("emerald", 24, new int[]{3, 6, 8, 3}, 30, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND
            , 1.0F, 0.0F, () -> Ingredient.fromItems(Items.EMERALD));
